...
export const LeavesDeco = ({ TypeLeaves, title, desc, img, Rotationnum, translateYnum, translateXnum, Width, Height, scale, Color1, Color2, Color1Opacity }) => {
  ...
  return (
    ...
    transform: "rotate("+Rotationnum+"deg) translate("+translateXnum+"vw, "+ translateYnum+"vw) scale("+scale+")"
     ,width:Width+"vw", height:Height+"vw", backgroundColor: Color1, borderColor: Color1, boxShadow: "0.5vw 1.5vw 0vw 0.5vw "+Color2,  ...movementLeaves, 
